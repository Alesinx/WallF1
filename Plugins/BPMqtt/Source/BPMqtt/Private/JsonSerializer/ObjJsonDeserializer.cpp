...
bool UObjJsonDeserializer::JsonValueToFStructProperty(const TSharedPtr<FJsonValue>& JsonValue, FStructProperty* StructProperty, void* OutValue)
{
	...
	static const FName NAME_Color2(TEXT("Color"));
	static const FName NAME_LinearColor2(TEXT("LinearColor"));
	...
	else if (JsonValue->Type == EJson::String && StructProperty->Struct->GetFName() == NAME_LinearColor2)
	{
	...
	else if (JsonValue->Type == EJson::String && StructProperty->Struct->GetFName() == NAME_Color2)
	{
